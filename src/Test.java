...
//		System.out.println(tmp);
		...
		//List<String> allmon = new ArrayList<String>();
...
//			for(Integer i = 0; i < allmon.size(); i++) {
//				output.write(allmon.get(i));
//				output.write("\n");
//			}
//			output.close();
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
//		String url = "https://pf.amac.org.cn/open/comNotice/list?currentPage=1";
//		Map<String, Integer> mymap = new HashMap<String, Integer>();
//		mymap = getIdFromPage(url);
//		System.out.println(mymap);
	...
	allmon = getAllMoney();
	try{
//		InputStream instream = new FileInputStream("/Users/stongan/Desktop/test.xls");
